...
yaml_template = '/home/yu79deg/darkfield_p5438/yamls/LP_177.yaml' #name of the template yaml file that we modify
...
param_dict = {
    'defect_lambda': [50,45,40,35,30,25,20,15,10,5,2], 
}
...
for i, combo in enumerate(combinations):
    ...
    if 'defect_lambda' in params:
        ...
        ip['A1']['defect_lambda'] = defect_lamb * 1e-6
