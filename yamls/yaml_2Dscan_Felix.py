...
yaml_template = '/home/yu79deg/darkfield_p5438/yamls/Felix_2.yaml' #name of the template yaml file that we modify
...
param_dict = {
    'O1_size': [5.0,10.0,20.0,40.0,80.0,100.0,130.0,150.0,180.0,200.0,300.0], 'wide_factor': [0.4, 0.5, 0.6, 0.7, 0.8, 0.9, 1, 1.2, 1.4], 
}
